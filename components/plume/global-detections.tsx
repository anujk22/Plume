...
export default function GlobalDetections({map}:{map:maplibregl.Map|null}){
 ...
 useEffect(()=>{
  ...
  const install=()=>{
   ...
   addFootprints();
   for(const id of ['global-clusters','global-counts','global-points'])if(map.getLayer(id))map.setLayerZoomRange(id,atmosphere?6:0,24);
